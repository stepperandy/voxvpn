...
const PERKS = [
  { icon: Zap,    label: 'WireGuard & OpenVPN',  desc: 'Industry-leading protocols' },
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-slate-400 text-base max-w-lg mx-auto">
            Connect through our high-speed infrastructure in 10+ countries. Every server runs WireGuard and OpenVPN with AES-256 encryption.
          </p>
        </motion.div>
